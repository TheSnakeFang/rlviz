...
function GuideLink({ href, label }: { href: string; label: string }) {
  return <a className="guide-link" href={href} target="_blank" rel="noreferrer">
    {href === "https://rlviz.dev" ? <img src="/favicon.svg" alt="" /> : href === "https://benchmarks.rlviz.dev" ? <svg viewBox="0 0 16 16" aria-hidden="true"><path fill="currentColor" d="M2 2h12v3H2V2Zm0 4.5h12v3H2v-3ZM2 11h12v3H2v-3Zm1-8v1h5V3H3Zm0 4.5v1h8v-1H3ZM3 12v1h6v-1H3Z" /></svg> : href === "https://github.com/TheSnakeFang/rlviz" ? <svg viewBox="0 0 16 16" aria-hidden="true"><path fill="currentColor" d="M8 0a8 8 0 0 0-2.53 15.59c.4.07.55-.17.55-.39l-.01-1.49c-2.23.49-2.7-1.08-2.7-1.08-.37-.93-.89-1.18-.89-1.18-.73-.5.05-.49.05-.49.81.06 1.23.83 1.23.83.72 1.23 1.88.88 2.34.67.07-.52.28-.88.51-1.08-1.78-.2-3.65-.89-3.65-3.95 0-.87.31-1.59.83-2.15-.08-.2-.36-1.02.08-2.12 0 0 .68-.22 2.2.82A7.67 7.67 0 0 1 8 3.71c.68 0 1.36.09 2 .27 1.53-1.04 2.2-.82 2.2-.82.44 1.1.16 1.92.08 2.12.52.56.83 1.28.83 2.15 0 3.07-1.87 3.75-3.65 3.95.29.25.54.74.54 1.5l-.01 2.32c0 .22.14.47.55.39A8 8 0 0 0 8 0Z" /></svg> : <svg viewBox="0 0 24 24" aria-hidden="true"><path fill="currentColor" d="M18.9 2h3.7l-8.1 9.2L24 22h-7.4l-5.8-7.6L4.2 22H.5l8.6-9.8L0 2h7.6l5.2 6.9L18.9 2Zm-1.3 18.1h2L6.5 3.8H4.3l13.3 16.3Z" /></svg>}
    <span>{label}</span>
  </a>;
}
...
const guideLinks = [
  ...
  { href: "https://benchmarks.rlviz.dev", label: "Benchmarks" },
